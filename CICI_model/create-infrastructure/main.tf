...
module "alb_module" {
  ...
  alb_security_group_id = [module.security_group_module.sg_alb_id]
...
module "asg_module" {
  ...
  subnet_ids                = module.vpc_module.subnet_public_ids
  target_group_arns         = [module.alb_module.tg_frontend_arn, 
                                module.alb_module.tg_backend_arn]  
}
...
module "route53_module" {
  ...
  route53_record_alias_name    = module.alb_module.alb_dns_name
  route53_record_alias_zone_id = module.alb_module.alb_zone_id
